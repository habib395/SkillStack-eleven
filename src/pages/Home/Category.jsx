      ...
      {filteredData.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
          {filteredData.map((item) => (
            ...
            //     <h2 className="card-title text-sm">{item.productBrand}</h2>
            //   </div>
            //   <p>
            //     <h2 className="text-sm text-center px-2">{item.queryTitle}</h2>
            //   </p>
            ...
            <div
              key={item._id}
              className="card bg-gray-50 bg-transparent shadow-lg py-1"
            >
