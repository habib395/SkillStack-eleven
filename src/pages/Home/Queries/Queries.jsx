  ...
  return (
    <div className="container  mx-auto sm:p-10">
      ...
      <div className="flex justify-center mb-6 gap-4">
        <button onClick={handleGrid1} className="btn bg-green-500">1 Column</button>
        <button onClick={handleGrid2} className="btn bg-green-500">2 Column</button>
        <button onClick={handleGrid3} className="btn bg-green-500">3 Column</button>
      </div>
