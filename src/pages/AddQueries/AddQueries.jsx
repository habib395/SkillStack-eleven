      ...
      <form onSubmit={handleAddQueries}>
        <div className="md:flex">
         ...
         <div className="form-control w-full">
            ...
            <input type="url" name="PhotoURL" placeholder="Photo" className="input input-bordered w-full" />
            </label>
         </div>
        </div>
         {/* photo URL */}
         ...
         <div className="form-control w-full">
            ...
            <label className="input-group">
            <input type="text" name="BoycottingReasonDetails" placeholder="ex: Is there any Better product that gives me the same quality?" className="input input-bordered w-full" />
            </label>
         </div>
        </div>
        {/* email and user Name */}
        ...
        <input type="submit" value="Add Query" className="btn btn-block bg-green-500 my-3" />
      </form>
    </div>
  );
};
